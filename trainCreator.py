...
def main():
    ...
    img_path = os.path.join('vtes', 'image.jpg')
    os.makedirs('vtes', exist_ok=True)
    img.save(img_path, quality=100)
    
    print("✓ 1 imagen del dataset VTES generada con 1-100 cartas, rotación aleatoria (-180° a +180°) y fondo aleatorio, guardada en vtes/image.jpg")
