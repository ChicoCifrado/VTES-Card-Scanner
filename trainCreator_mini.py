...
def main():
    """Función principal para generar 10 imágenes del dataset VTES."""
    ...
    print("✓ 10 imágenes del dataset VTES generadas, cada una con 1-100 cartas, rotación aleatoria (-180° a +180°) y fondo aleatorio, guardadas en vtes-mini")
